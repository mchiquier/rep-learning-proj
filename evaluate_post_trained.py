...
out_channels = TASKS_TO_CHANNELS[feature_task]
encoder_path = TASKONOMY_PRETRAINED_URLS[feature_task + "_encoder"]
decoder_path = TASKONOMY_PRETRAINED_URLS[feature_task + "_decoder"],
...
post_trained_model_path = "./post_trained_normals.pth"
decoder_nets_bis = nets_bis[0].to(default_device)
decoder_nets_bis_checkpoint = torch.load(post_trained_model_path)
decoder_nets_bis.load_state_dict(decoder_nets_checkpoint)

decoder_nets.encoder = decoder_nets_bis.encoder
